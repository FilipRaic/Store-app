 ...
 */
public class Drink extends Item implements Edible {
    private final int calPerKg = 100;
    private BigDecimal weight;

    /**
     * Constructor for Drink objects
     *
     ...
     */
    public Drink(Long id, String name, Category category, BigDecimal width, BigDecimal height, BigDecimal length, BigDecimal productionCost, BigDecimal sellingPrice, Discount discount, BigDecimal weight) {
    ...
    public boolean equals(Object o) {
        ...
        Drink drink = (Drink) o;
        return calPerKg == drink.calPerKg && Objects.equals(weight, drink.weight);
    }
    ...
    /**
     * Overrides a method in Edible interface that is used to calculate how many kilocalories a drink contains
     *
    ...
    /**
     * Overrides a method in Edible interface and is used to calculate the price of a drink based on selling price, weight and discount
     *
